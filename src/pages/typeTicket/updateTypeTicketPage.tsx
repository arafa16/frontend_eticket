...
import { getDataTypeTicketById, updateDataTypeTicket } from '../../features/typeTicket/typeTicket';

const updateTypeTicketPage = () => {
    const {id} = useParams();
    ...
    const {dataResult} = getDataTypeTicketById({uuid:id})
    ...
    const {message, updateAction} = updateDataTypeTicket({
...
export default updateTypeTicketPage