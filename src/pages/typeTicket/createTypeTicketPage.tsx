...
import { createDataTypeTicket } from '../../features/typeTicket/typeTicket';

const createTypeTicketPage = () => {
    ...
    const {message, createAction} = createDataTypeTicket({
        name,
        sequence,
        is_select, 
        is_active
...
export default createTypeTicketPage