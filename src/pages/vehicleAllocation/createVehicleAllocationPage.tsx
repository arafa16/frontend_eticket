...
import { createDataVehicleAllocation } from "../../features/vehicleAllocation/vehicleAllocation";

const createVehicleAllocationPage = () => {
  ...
  const { message, createAction } = createDataVehicleAllocation({
    name,
    sequence,
    is_select,
    is_active,
...
export default createVehicleAllocationPage;
