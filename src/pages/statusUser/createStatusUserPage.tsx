...
import { createDataStatusUser } from '../../features/statusUser/statusUser';

const createStatusUserPage = () => {
    ...
    const {message, createAction} = createDataStatusUser({
        name,
        sequence,
        is_select, 
        is_active
...
export default createStatusUserPage