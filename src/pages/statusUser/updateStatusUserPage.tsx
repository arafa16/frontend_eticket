...
import { getDataStatusUserById, updateDataStatusUser } from '../../features/statusUser/statusUser';

const updateStatusUserPage = () => {
    const {id} = useParams();
    ...
    const {dataResult} = getDataStatusUserById({uuid:id});
    ...
    const {message, updateAction} = updateDataStatusUser({
...
export default updateStatusUserPage