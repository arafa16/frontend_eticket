...
const viewTicketPage = () => {
  ...
  const { dataResult, statusTicketId, reload, history, view } =
    getDataTicketView({ uuid: id });
  ...
  const {
    ...
    uuid: id,
    status_ticket_id: statusTicketId,
    reload,
    isActive: false,
  });

  const { view: viewDataNoteTicket } = getDataNoteTicket({
    uuid: id,
    reload,
    isActive: false,
  });
