...
import { getDataPenempatanById, updateDataPenempatan } from '../../features/penempatan/penempatan';
import Button from '../../base-components/Button';
import FormAttribute from '../../components/formTemplate/formAttribute';

const updatePenempatanPage = () => {
    const {id} = useParams();
    ...
    const {dataResult} = getDataPenempatanById({uuid:id});
    ...
    const {message, updateAction} = updateDataPenempatan({
...
export default updatePenempatanPage