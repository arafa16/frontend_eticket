...
import { createDatas } from '../../features/projectStatus/projectStatus';

const createProjectStatusPage = () => {
    ...
    const {message, createAction} = createDatas({
        name,
        sequence,
        is_select, 
        is_active
...
export default createProjectStatusPage