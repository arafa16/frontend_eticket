...
import { getDatasById, updateDatas } from '../../features/projectStatus/projectStatus';

const updateProjectStatusPage = () => {
    const {id} = useParams();
    ...
    const {dataResult} = getDatasById({uuid:id})
    ...
    const {message, updateAction} = updateDatas({
...
export default updateProjectStatusPage