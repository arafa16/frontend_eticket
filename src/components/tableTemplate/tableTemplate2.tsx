...
const tableTemplate2 = (props:any) => {
    const {
        search, setSearch,
        datas,
        count,
                            ...
                            <div className="flex px-5 py-3">
                                ...
                                <div className="w-64 truncate sm:w-32" >
                                    <span
                                        ...
                                        >
                                        {data && data.project_type && data.project_type.name}
                                    </span>
                                </div>
                                <div className="w-64 truncate sm:w-32" >
                                    <span
                                        ...
                                        >
                                        {data && data.executor && data.executor.name}
                                    </span>
                                </div>
                                <div
                                className={clsx([
                                ...
                                >
                                    {data && data.project_status && data.project_status.name}
                                </div>
                            </div>
                            </div>
                        </div>
