    ...
    <div className="w-full box p-8">
      <form onSubmit={submit}>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-10 ">
          ...
          <div>
            <div className="font-medium whitespace-nowrap">User</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
          ...
          <div>
            <div className="font-medium whitespace-nowrap">executor</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
                aria-label=".form-select-sm example"
          ...
          <div>
            <div className="font-medium whitespace-nowrap">Project Type</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
                aria-label=".form-select-sm example"
          ...
          <div>
            <div className="font-medium whitespace-nowrap">Target Date</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormInput
                formInputSize="sm"
                id="target_date"
