...
const FormUser = (props: any) => {
  ...
  const { data: statusUserSelect, loading: loadingStatusUser } =
    getDataStatusUserSelect();
    ...
    <div className="w-full box p-8">
      <form onSubmit={submit}>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-10 ">
          ...
          <div>
            <div className="font-medium whitespace-nowrap">Email</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormInput
                formInputSize="sm"
                id="email"
          ...
          <div className={`${viewPassword !== true ? "hidden" : ""}`}>
            <div className={`font-medium whitespace-nowrap`}>Passowrd</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormInput
                formInputSize="sm"
                id="email"
          ...
          <div>
            <div className="font-medium whitespace-nowrap">Devisi</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
              ...
              >
                <option></option>
                {devisiSelect &&
                  devisiSelect.map((data: any, index: any) => (
          ...
          <div>
            <div className="font-medium whitespace-nowrap">Penempatan</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
                aria-label=".form-select-sm example"
              ...
              >
                <option></option>
                {penempatanSelect &&
                  penempatanSelect.map((data: any, index: any) => (
                    <option key={index} value={data.uuid}>
                      {data.name}
                    </option>
                  ))}
          ...
          <div>
            <div className="font-medium whitespace-nowrap">Nomor Hp</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormInput
                formInputSize="sm"
                id="email"
          ...
          <div className={`${viewStatus !== true ? "hidden" : ""}`}>
            <div className="font-medium whitespace-nowrap">Status User</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
                aria-label=".form-select-sm example"
              ...
              >
                <option></option>
                {statusUserSelect &&
                  statusUserSelect.map((data: any, index: any) => (
                    <option key={index} value={data.uuid}>
                      {data.name}
                    </option>
                  ))}
          ...
          <div className={`${viewExecutor !== true ? "hidden" : ""}`}>
            <div className="font-medium whitespace-nowrap">Is Executor</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
                aria-label=".form-select-sm example"
          ...
          <div className={`${viewDriver !== true ? "hidden" : ""}`}>
            <div className="font-medium whitespace-nowrap">Is Driver</div>
            <div className="mt-1 text-sm text-slate-500 pr-6">
              <FormSelect
                formSelectSize="sm"
                aria-label=".form-select-sm example"
