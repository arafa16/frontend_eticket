                ...
                <div className="flex gap-x-4 items-center">
                  <div
                    className={`flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-success ${
                      stage === 1 ? "bg-success/20" : "bg-secondary/20"
                    } border-secondary/20`}
                  >
                    <Lucide className="w-[1.3rem] h-[1.3rem]" icon="PieChart" />
                  </div>
            ...
            <div data-content>
              <div className="flex">
                <div className="flex gap-x-4 items-center">
                  <div
                    className={`flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-success ${
                      stage === 2 ? "bg-success/20" : "bg-secondary/20"
                    } border-secondary/20`}
                  >
                    <Lucide className="w-[1.3rem] h-[1.3rem]" icon="PieChart" />
                  </div>
            ...
            <div data-content>
              <div className="flex">
                <div className="flex gap-x-4 items-center">
                  <div
                    className={`flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-success ${
                      stage === 3 ? "bg-success/20" : "bg-secondary/20"
                    } border-secondary/20`}
                  >
                    <Lucide className="w-[1.3rem] h-[1.3rem]" icon="PieChart" />
                  </div>
            ...
            <div data-content>
              <div className="flex">
                <div className="flex gap-x-4 items-center">
                  <div
                    className={`flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-success ${
                      stage === 4 ? "bg-success/20" : "bg-secondary/20"
                    } border-secondary/20`}
                  >
                    <Lucide className="w-[1.3rem] h-[1.3rem]" icon="PieChart" />
                  </div>
            ...
            <div data-content>
              <div className="flex">
                <div className="flex gap-x-4 items-center">
                  <div
                    className={`flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-success ${
                      stage === 5 ? "bg-success/20" : "bg-secondary/20"
                    } border-secondary/20`}
                  >
                    <Lucide className="w-[1.3rem] h-[1.3rem]" icon="PieChart" />
                  </div>
            ...
            <div data-content>
              <div className="flex">
                <div className="flex gap-x-4 items-center">
                  <div
                    className={`flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-success ${
                      stage === 0 ? "bg-success/20" : "bg-secondary/20"
                    } border-secondary/20`}
                  >
                    <Lucide className="w-[1.3rem] h-[1.3rem]" icon="PieChart" />
                  </div>
