...
import {
  getStatusTicket,
  resetStatusTicket,
} from "../../stores/features/statusTicketSlice";
import {
  UpdateStatusTicket,
  resetTicket,
...
import {
  ...
  resetStatusTicket2,
} from "../../stores/features/statusTicket2Slice";
...
export const statusTicketView = (datas: any) => {
  ...
  const {
    ...
    isSuccess,
    isLoading,
    message: messageStatusTicket,
  } = useSelector((state: any) => state.statusTicket);
  ...
  const {
    ...
    message: messageStatusTicket2,
  } = useSelector((state: any) => state.statusTicket2);
