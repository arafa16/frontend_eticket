...
import { GetTicket, resetTicket } from "../../stores/features/ticketSlice";
import { useEffect, useState } from "react";
import dayjs from "dayjs";
import { useNavigate } from "react-router-dom";
import { FormInput } from "../../base-components/Form";

export const dataTicketAll = (datas:any) => {
    ...
    useEffect(()=>{
        const paramsObj : any = { page, limit, notStatus};
        const searchParams = new URLSearchParams(paramsObj);

        dispatch(GetTicket(searchParams.toString()));

    },[page, limit, notStatus])
                ...
                <Table.Tr key={key} className="intro-x">
                    ...
                    <div className="flex items-center justify-center">
                        <p
                            ...
                            onClick={()=>navigate(`${datas.link_view}${data.uuid}`)}
                        >
