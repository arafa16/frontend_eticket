  ...
  const view = (
    <div className="w-full box text-xs p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-10 mt-10 border-b border-slate-200/60 dark:border-darkmode-400 pb-10">
        <div>
          <div className="font-medium whitespace-nowrap">Type Ticket</div>
          <div className="mt-1 text-slate-500 text-justify">
            {dataResult && dataResult.type_ticket.name}
          </div>
        </div>
        <div>
          <div className="font-medium whitespace-nowrap">Create Date</div>
        ...
        <div>
          <div className="font-medium whitespace-nowrap">PIC</div>
          <div className="mt-1 text-slate-500 text-justify">
            {dataResult && dataResult.executor_id !== null
              ? dataResult.executor.name
              : "waiting response"}
          </div>
        </div>
      </div>
