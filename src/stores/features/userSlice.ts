...
export const ResetPasswordByUser: any = createAsyncThunk("user/ResetPassword", async(data : any, thunkAPI) => {
    try {
        const response = await axios.patch(import.meta.env.VITE_REACT_APP_API_URL+`/user/password/${data.uuid}`, {
...
export const getUserSelect: any = createAsyncThunk("user/getUserSelect", async(data : any, thunkAPI) => {
    try {
